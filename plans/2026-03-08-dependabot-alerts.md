...
|---|---|---|---|---|
| `fast-xml-parser` | 5.2.5 | 5.3.6 | tools/package.json (直接依存) | #136,#137,#164,#165,#167,#168 |
| `axios` | 1.11.0 | 1.13.5 | tools/package.json (直接依存) | #149 |
| `glob` | 11.0.3 | 11.1.0(package.jsonは11.1.0指定、lockは11.0.3) | package.json (直接依存) | #102 |
...
# ルート
pnpm update glob storybook mdast-util-to-hast
```
