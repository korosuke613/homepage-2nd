  ...
  return (
    <div className="mb-4">
      ...
      <details className="group">
        <summary className="flex items-center justify-between w-full p-3 bg-slate-800 hover:bg-slate-700 rounded-lg transition-colors duration-200 border border-slate-600 cursor-pointer list-none">
          <span className="font-semibold text-gray-100">目次</span>
          <svg
            className="w-5 h-5 text-gray-300 transition-transform duration-200 group-open:rotate-180"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
            role="img"
